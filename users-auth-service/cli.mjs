...
program
  ...
  .action((username, cmdObj) => {
    ...
    const userClient = client(program);
...
program
  ...
  .option('--password <password>', 'Updated password for the user')
  .option(
    '--family-name <familyName>',
    'Updated family name, or last name, of the user'
  )
  .option(
    '--given-name <givenName>',
    'Updated given name, or first name, of the user'
  )
  .option('--middle-name <middleName>', 'Updated middle name of the user')
  .option('--email <email>', 'Updated email address of the user')
  .action((username, cmdObj) => {
    const topost = {
      username,
      password: cmdObj.password,
...
program
  ...
  .description('Check whether the password checks out')
